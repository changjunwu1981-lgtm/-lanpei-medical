...
2026-06-15 第104-108号
- 104 玛伐凯泰胶囊 Mavacamten - 梗阻性肥厚型心肌病(oHCM)
- 105 来那帕韦钠片 Lenacapavir (Sunlenca) - 多重耐药HIV-1 / HIV PrEP
- 106 盐酸替那帕诺片 Tenapanor - 透析高磷血症 / IBS-C
- 107 莫博赛替尼 Mobocertinib - EGFR Ex20ins非小细胞肺癌
- 108 奈拉替尼片 Neratinib (贺俪安) - HER2阳性乳腺癌
"""
import os
...
DRUGS = [
    {
        "num": 104,
        "name": "玛伐凯泰胶囊",
        "generic_en": "Mavacamten Capsules",
        "brand": "LuciMava",
        "category": "心血管病",
        "indication": "纽约心脏协会(NYHA)心功能分级II-III级的梗阻性肥厚型心肌病(oHCM)成人患者，改善功能容量和症状",
        "spec": "2.5mg/粒、5mg/粒、10mg/粒、15mg/粒",
        "category_label": "心肌肌球蛋白抑制剂",
        "drug_class": "心肌肌球蛋白可逆性变构抑制剂（首创First-in-Class）",
        "moa": "通过可逆性抑制心肌肌球蛋白ATP酶，减少肌球蛋白-肌动蛋白横桥形成，从而降低心肌过度收缩力、缓解左心室流出道梗阻（LVOT）",
        "dosage": "推荐起始剂量5mg/日（CYP2C19慢代谢者2.5mg/日），口服每日1次；通过超声心动图Valsalva动作LVOT压差和LVEF调整，每4-8周评估1次，最大剂量15mg/日",
        "monitor": "开始治疗前需进行CYP2C19基因型检测；用药前及剂量调整后4、8、12周通过超声心动图评估LVEF和LVOT压差；LVEF<50%须立即停药4周，LVEF恢复≥50%后方可重启",
        "adverse": "常见：头晕(27%)、头痛(13%)、疲劳(9%)、心悸(8%)、房颤(8%)；严重：左心室收缩功能障碍(LVEF<50%，发生率2-7%)、心衰、晕厥",
        "missed": "若漏服，应在当天尽快补服；若已接近下次服药时间(<12小时)则跳过漏服剂量，下次按原计划服用；切勿双倍补服",
        "title_seo": "玛伐凯泰胶囊用法用量详解｜CAMZYOS迈凡妥靶向治疗梗阻性肥厚型心肌病用药指南",
        "description_seo": "玛伐凯泰胶囊(Mavacamten)用法用量详解，原研药CAMZYOS迈凡妥治疗NYHA II-III级梗阻性肥厚型心肌病(oHCM)，老挝LuciMava版本咨询，全球优质医疗资源",
        "keywords_seo": "玛伐凯泰胶囊,mavacamten用法,玛伐凯泰价格,CAMZYOS,迈凡妥,梗阻性肥厚型心肌病,oHCM,心肌肌球蛋白抑制剂",
        "price_original": "迈凡妥/Camzyos 5mg×28粒/盒 约30000-40000元(中国上市价,首批处方药)",
        "price_generic": "老挝LuciMava 5mg×30粒/盒 约3000-5000元(海外经济版)",
        "cta_title_zh": "需要咨询玛伐凯泰药品渠道和价格信息？",
        "pinyin": "mavacamten",
    },
    {
        "num": 105,
        "name": "来那帕韦钠片",
        "generic_en": "Lenacapavir Sodium (Sunlenca)",
        "brand": "LuciLenacap",
        "category": "抗病毒",
        "indication": "与其他抗逆转录病毒药物联用，治疗多重耐药HIV-1感染的成人患者（接受过大量抗病毒治疗、当前方案因耐药/不耐受/安全性失败）；2025年6月FDA批准用于HIV暴露前预防(PrEP)",
        "spec": "片剂300mg；注射剂463.5mg/1.5mL",
        "category_label": "HIV-1衣壳抑制剂",
        "drug_class": "首创(First-in-Class)HIV-1衣壳抑制剂",
        "moa": "通过与HIV-1衣壳蛋白结合，干扰衣壳介导的多个关键步骤：阻断病毒DNA进入细胞核、抑制病毒DNA复制、阻止病毒颗粒组装，是首个被批准的衣壳抑制剂",
        "dosage": "口服诱导+皮下注射维持：方案一(Day1) 927mg皮下注射+600mg口服(Day1)+600mg口服(Day2)，之后每6月(26周)注射927mg；方案二 600mg口服(Day1)+600mg(Day2)+300mg(Day8)+Day15 927mg皮下注射",
        "monitor": "治疗前HIV-1 RNA载量、CD4+计数、肝肾功能；用药后2-4周评估病毒学应答；PrEP使用前必须HIV-1阴性，注射期间每2月1次HIV筛查；避免强CYP3A诱导剂合用",
        "adverse": "常见：注射部位反应(结节/硬结可持久)、恶心(4%)、头痛(3%)、疲劳；严重：注射部位严重反应(误皮内注射可致)、免疫重建综合征、乙肝合并感染者停药可致乙肝急性加重",
        "missed": "维持期若距上次注射超过28周，需重新从Day1启动诱导方案；计划延迟可使用口服300mg每周1次桥接",
        "title_seo": "来那帕韦钠片用法用量详解｜SUNLENCA长效HIV衣壳抑制剂用药指南",
        "description_seo": "来那帕韦钠片(Lenacapavir)用法用量详解，原研药SUNLENCA治疗多重耐药HIV-1/HIV PrEP，老挝LuciLenacap版本咨询，全球优质医疗资源",
        "keywords_seo": "来那帕韦钠片,lenacapavir用法,SUNLENCA,LuciLenacap,HIV-1衣壳抑制剂,多重耐药HIV,HIV PrEP,长效HIV注射",
        "price_original": "SUNLENCA 300mg×4片/盒+927mg注射 约20000-30000元/起始剂(海外原研)",
        "price_generic": "老挝LuciLenacap 300mg×30片/盒 约5000-8000元(海外经济版)",
        "cta_title_zh": "需要咨询来那帕韦钠片药品渠道和价格信息？",
        "pinyin": "lenacapavir",
    },
    {
        "num": 106,
        "name": "盐酸替那帕诺片",
        "generic_en": "Tenapanor Hydrochloride Tablets",
        "brand": "LuciTena",
        "category": "综合药品",
        "indication": "美国FDA双适应症：①成人便秘型肠易激综合征(IBS-C)治疗；②成人慢性肾脏病(CKD)透析患者高磷血症，作为磷结合剂治疗不充分或不耐受患者的添加治疗(中国2025年2月获批透析高磷血症)",
        "spec": "10mg/片、20mg/片、30mg/片(IBS-C为50mg)",
        "category_label": "钠/氢交换体-3(NHE3)抑制剂",
        "drug_class": "NHE3抑制剂",
        "moa": "通过抑制小肠和结肠上皮细胞表面的钠/氢交换体-3(NHE3)，减少钠和磷酸盐的肠道吸收；用于高磷血症时通过降低肠道磷酸盐吸收来降低血清磷",
        "dosage": "透析高磷血症：推荐剂量30mg，口服每日2次，分别于当日第一餐和最后一餐前立即服用；可根据耐受性调整至20mg或10mg每日2次；IBS-C：50mg每日2次于早餐和晚餐前立即服用",
        "monitor": "治疗前及治疗期间定期监测血清磷水平(IBS-C无需)；监测胃肠道耐受性(腹泻最常见)；血液透析患者不要在透析前立即服药，改为透析后下一餐前服用；OATP2B1底物药物联用需调整",
        "adverse": "高磷血症患者：腹泻(43-53%，重度6%)、腹痛；IBS-C患者：腹泻(11-16%)、腹胀、胀气、头晕；均无肝毒性报告；<6岁儿童禁用(有脱水致死风险)",
        "missed": "若漏服一剂，跳过漏服剂量，在下次常规服药时间服用下一剂；不可同时服用2倍剂量",
        "title_seo": "盐酸替那帕诺片用法用量详解｜万缇乐/XPHOZAH降血磷新机制用药指南",
        "description_seo": "盐酸替那帕诺片(Tenapanor)用法用量详解，原研药万缇乐/XPHOZAH治疗CKD透析高磷血症/IBS-C，老挝LuciTena版本咨询，全球优质医疗资源",
        "keywords_seo": "盐酸替那帕诺片,tenapanor用法,替那帕诺价格,万缇乐,XPHOZAH,IBSRELA,降血磷,IBS-C,NHE3抑制剂",
        "price_original": "万缇乐(中国2025年)30mg×60片/盒 价格待公布(中国新上市);美国XPHOZAH 30mg×60片/盒 约1500-2000美元",
        "price_generic": "老挝LuciTena 30mg×30片/盒 约500-1000元(海外经济版)",
        "cta_title_zh": "需要咨询盐酸替那帕诺片药品渠道和价格信息？",
        "pinyin": "tenapanor",
    },
    {
        "num": 107,
        "name": "莫博赛替尼",
        "generic_en": "Mobocertinib (Exkivity)",
        "brand": "LuciMob",
        "category": "肺癌",
        "indication": "用于含铂化疗期间或之后疾病进展、且携带EGFR 20号外显子插入突变(EGFR ex20ins)的局部晚期或转移性非小细胞肺癌(NSCLC)成人患者（附条件批准，需基因检测确诊）",
        "spec": "40mg/粒",
        "category_label": "EGFR ex20ins靶向药",
        "drug_class": "高选择性不可逆EGFR酪氨酸激酶抑制剂(首创针对ex20ins突变型)",
        "moa": "通过不可逆地共价结合到EGFR 20号外显子插入突变位点，抑制酪氨酸激酶活性，阻断下游RAS/RAF/MEK/ERK和PI3K/AKT信号通路；专门针对ex20ins突变设计，对野生型EGFR影响较小",
        "dosage": "推荐剂量160mg(4粒40mg)，口服每日1次，可与食物同服或空腹；整粒吞服，不可压碎、咀嚼或溶解；漏服>6小时或服药后呕吐均不补服",
        "monitor": "用药前基因检测确认EGFR ex20ins突变；基线及治疗期间定期心电图监测QTc间期(避免>500ms)；电解质(尤其血钾/镁)；肝功能；出现咳嗽/呼吸困难警惕间质性肺病(2.6%)",
        "adverse": "常见：腹泻(90%，3-4级21%)、皮疹(45%)、甲沟炎(38%)、恶心、口腔黏膜炎、食欲下降；严重：QTc间期延长(黑框警告)、间质性肺病(2.6%)、心衰(LVEF下降)、腹泻所致脱水",
        "missed": "若漏服一次剂量且距下次服药<6小时，跳过该次不补服；若服药后发生呕吐，不再补服，按原计划下次服用",
        "title_seo": "莫博赛替尼用法用量详解｜EXKIVITY安卫力EGFR ex20ins靶向药用药指南",
        "description_seo": "莫博赛替尼(Mobocertinib)用法用量详解，原研药EXKIVITY安卫力治疗EGFR ex20ins突变非小细胞肺癌，老挝LuciMob版本咨询，全球优质医疗资源",
        "keywords_seo": "莫博赛替尼,mobocertinib用法,莫博赛替尼价格,EXKIVITY,安卫力,EGFR 20外显子插入突变,NSCLC靶向药,ex20ins",
        "price_original": "EXKIVITY 40mg×120粒/盒 约36000元(中国上市价)",
        "price_generic": "老挝LuciMob 40mg×120粒/盒 约5000-8000元(海外经济版)",
        "cta_title_zh": "需要咨询莫博赛替尼药品渠道和价格信息？",
        "pinyin": "mobocertinib",
    },
    {
        "num": 108,
        "name": "奈拉替尼片",
        "generic_en": "Neratinib Tablets (Nerlynx)",
        "brand": "LuciNera",
        "category": "乳腺癌",
        "indication": "①单药用于早期HER2阳性乳腺癌成年患者的延长辅助治疗(在含曲妥珠单抗辅助治疗之后)②联合卡培他滨治疗既往接受过2种或以上抗HER2方案的晚期或转移性HER2阳性乳腺癌",
        "spec": "40mg/片",
        "category_label": "HER2阳性乳腺癌靶向药",
        "drug_class": "不可逆泛HER酪氨酸激酶抑制剂(TKI)，靶向EGFR/HER1、HER2、HER4",
        "moa": "通过与HER家族(EGFR/HER1、HER2、HER4)激酶区的ATP结合口袋不可逆共价结合，永久性抑制激酶活性，阻断下游信号通路；与可逆TKI不同，可减少因HER2突变导致的耐药",
        "dosage": "推荐剂量240mg(6片)，口服每日1次，随餐服用；推荐两周剂量递增法：第1周120mg/日→第2周160mg/日→第3周起240mg/日；联合卡培他滨方案为21天周期第1-21天240mg/日+第1-14天卡培他滨750mg/m²每日2次",
        "monitor": "治疗前3个月每月监测肝功能(转氨酶/胆红素)，之后每3月1次；腹泻预防：未用剂量递增者首剂开始即用洛哌丁胺(前56天维持1-2次/日排便)；重度肝功能损害者起始剂量降至80mg/日",
        "adverse": "常见：腹泻(95%最常见，3-4级40%)、恶心、呕吐、腹痛、疲劳、皮疹、口腔炎、肌痉挛、指甲障碍；严重：重度腹泻可致脱水、3-4级肝毒性(需永久停药)、胚胎-胎儿毒性",
        "missed": "漏服一剂不得补服，应在次日按原计划时间服用当日剂量；任何情况下不可服用双倍剂量",
        "title_seo": "奈拉替尼片用法用量详解｜贺俪安NERLYNX HER2阳性乳腺癌延长辅助治疗用药指南",
        "description_seo": "奈拉替尼片(Neratinib)用法用量详解，原研药贺俪安NERLYNX治疗早期/晚期HER2阳性乳腺癌，老挝LuciNera版本咨询，全球优质医疗资源",
        "keywords_seo": "奈拉替尼片,neratinib用法,奈拉替尼价格,贺俪安,NERLYNX,HER2阳性乳腺癌,延长辅助治疗,卡培他滨联合",
        "price_original": "贺俪安/Nerlynx 40mg×180片/盒 约20000-30000元(已纳入中国医保乙类)",
        "price_generic": "老挝LuciNera 40mg×180片/盒 约3000-5000元(海外经济版)",
        "cta_title_zh": "需要咨询奈拉替尼片药品渠道和价格信息？",
        "pinyin": "neratinib",
    },
]
...
def get_gzh_article(drug):
    title_emojis = {
        "玛伐凯泰胶囊": ("❤️", "全球首创心肌肌球蛋白抑制剂，40年来首个oHCM靶向新药"),
        "来那帕韦钠片": ("💊", "首创HIV衣壳抑制剂，每年仅需2针长效注射"),
        "盐酸替那帕诺片": ("🩺", "全球唯一获批的降血磷创新机制药"),
        "莫博赛替尼": ("🎯", "EGFR ex20ins突变NSCLC国产首款靶向药"),
        "奈拉替尼片": ("🎗️", "HER2阳性乳腺癌延长辅助治疗新选择"),
    }
...
def main():
    ...
    output_dir = os.path.join(work_root, "蓝培医疗文章/2026-06-15")
