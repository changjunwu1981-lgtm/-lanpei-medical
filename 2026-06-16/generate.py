...
2026-06-16 第109-113号
- 109 阿法替尼 Afatinib (普来润) - EGFR突变NSCLC
- 110 贝组替凡 Belzutifan (WELIREG) - VHL/晚期肾细胞癌
- 111 比克恩丙诺 Bictegravir (Biktarvy) - HIV-1
- 112 安立生坦 Ambrisentan (凡瑞克) - 肺动脉高压PAH
- 113 兰泽替尼 Lazertinib (LAZCLUZE) - EGFR突变NSCLC(联合amivantamab)
"""
import os
...
DRUGS = [
    {
        "num": 109,
        "name": "阿法替尼片",
        "generic_en": "Afatinib Tablets (Gilotrif/GIOTRIF)",
        "brand": "LuciAfa",
        "category": "肺癌",
        "indication": "①具有表皮生长因子受体(EGFR)基因敏感突变的局部晚期或转移性非小细胞肺癌(NSCLC)，既往未接受过EGFR-TKI治疗;②含铂化疗期间或化疗后疾病进展的局部晚期或转移性鳞状组织学类型的非小细胞肺癌(NSCLC)",
        "spec": "20mg/片、30mg/片、40mg/片",
        "category_label": "EGFR突变NSCLC靶向药",
        "drug_class": "第二代不可逆ErbB家族酪氨酸激酶抑制剂(TKI)，靶向EGFR(HER1)、HER2与HER4",
        "moa": "通过与EGFR(HER1)、HER2、HER4激酶区ATP结合口袋共价不可逆结合，永久性阻断下游RAS/RAF/MEK/ERK和PI3K/AKT信号通路；与第一代可逆TKI相比，对T790M耐药突变和HER2也有活性",
        "dosage": "推荐剂量40mg(1片)，口服每日1次，空腹服用(餐前至少1小时或餐后至少3小时)；应整片用水吞服；持续治疗直至疾病进展或患者不能耐受",
        "monitor": "用药前必须经批准的检测方法确定EGFR突变状态(19del或L858R为敏感突变)；治疗期间监测腹泻(最常见不良反应，95%发生率)、皮疹、肝功能、间质性肺病(ILD,1.6%)、角膜炎(0.7%);出现急性呼吸道症状警惕ILD,确诊应永久停药",
        "adverse": "常见：腹泻(95%发生率，3-4级约15%)、皮疹/痤疮样皮疹(80-90%)、口腔炎/黏膜炎、甲沟炎(50-60%)、皮肤干燥、食欲下降、恶心呕吐、瘙痒；严重：3-4级腹泻可致脱水、3-4级肝毒性(罕见致死)、间质性肺病ILD(1.6%)、消化道穿孔(0.2%)、角膜炎(0.7%)、胚胎-胎儿毒性",
        "missed": "漏服一剂应在当天记起时尽快服用；若距下次服药时间不足8小时，则不需要额外补充漏服剂量；任何情况下不可服用双倍剂量",
        "title_seo": "阿法替尼片用法用量详解｜普来润Gilotrif EGFR突变非小细胞肺癌靶向用药指南",
        "description_seo": "阿法替尼片(Afatinib)用法用量详解，原研药普来润/Gilotrif治疗EGFR敏感突变NSCLC(19del/L858R)及鳞癌二线，老挝LuciAfa版本咨询，全球优质医疗资源",
        "keywords_seo": "阿法替尼片,afatinib用法,阿法替尼价格,普来润,Gilotrif,GIOTRIF,EGFR突变,非小细胞肺癌,NSCLC靶向药,LuciAfa",
        "price_original": "吉泰瑞/Gilotrif 40mg×30片/盒 约8000-12000元(原研进口,已纳入中国医保乙类)",
        "price_generic": "老挝LuciAfa 40mg×30片/盒 约1500-2500元(海外经济版)",
        "cta_title_zh": "需要咨询阿法替尼片药品渠道和价格信息？",
        "pinyin": "afatinib",
    },
    {
        "num": 110,
        "name": "贝组替凡片",
        "generic_en": "Belzutifan Tablets (WELIREG)",
        "brand": "LuciBelzu",
        "category": "肾癌",
        "indication": "①治疗需要治疗相关肾细胞癌(RCC)、中枢神经系统血管母细胞瘤(CNS hemangioblastomas)或胰腺神经内分泌肿瘤(pNET)的von Hippel-Lindau(VHL)病成人患者，不需立即手术者;②接受过PD-1/PD-L1抑制剂和VEGF-TKI治疗后的晚期肾细胞癌(RCC)含透明细胞成分患者",
        "spec": "40mg/片",
        "category_label": "VHL病/晚期肾癌靶向药",
        "drug_class": "首创(First-in-Class)缺氧诱导因子2α(HIF-2α)抑制剂",
        "moa": "通过与HIF-2α结合，在缺氧或VHL蛋白功能受损条件下阻断HIF-2α与HIF-1β的相互作用，从而减少HIF-2α靶基因(促红细胞生成素EPO、血管内皮生长因子VEGF等)的转录和表达；正常氧条件下VHL蛋白会降解HIF-2α,VHL功能缺陷时HIF-2α累积导致VHL相关肿瘤",
        "dosage": "推荐剂量120mg(3片40mg)，口服每日1次，可与食物同服或空腹；每天大致相同时间服用；整片吞服，不可咀嚼、压碎或掰开；持续治疗直至疾病进展或不可接受的毒性",
        "monitor": "治疗前需用经批准的检测方法确诊VHL病(基因检测)或晚期RCC的透明细胞成分；治疗期间密切监测血红蛋白(贫血发生率88-93%,严重需输血)、血氧饱和度(警惕缺氧,联合治疗者VTE发生率36%建议前4个月预防性抗凝)、肝肾功能;出现危及生命或反复症状性缺氧须永久停药",
        "adverse": "常见：贫血(88-93%，3-4级约7-29%)、疲劳(60%+)、恶心、眩晕、呼吸困难、头痛、肌痛、便秘、外周水肿；严重：缺氧(联合治疗VTE发生率36%)、3-4级贫血(需输血或ESAs)、危及生命的缺氧(永久停药)、胚胎-胎儿毒性(黑框警告)",
        "missed": "若漏服一剂，应在当天记起时尽快补服；次日恢复常规每日剂量；不可服用额外药片来弥补漏服剂量；若服药后任何时间发生呕吐，不补服，次日服用下一剂",
        "title_seo": "贝组替凡片用法用量详解｜WELIREG VHL病相关肿瘤与晚期肾癌靶向药用药指南",
        "description_seo": "贝组替凡片(Belzutifan)用法用量详解，原研药WELIREG治疗VHL病相关肾癌/CNS血管母细胞瘤/pNET及晚期肾透明细胞癌，老挝LuciBelzu版本咨询，全球优质医疗资源",
        "keywords_seo": "贝组替凡片,belzutifan用法,WELIREG,LuciBelzu,HIF-2α抑制剂,VHL病,晚期肾细胞癌,RCC靶向药,透明细胞肾癌",
        "price_original": "WELIREG 40mg×90片/盒 约50000-70000元(美国/欧洲原研价,国内未上市)",
        "price_generic": "老挝LuciBelzu 40mg×30片/盒 约5000-8000元(海外经济版)",
        "cta_title_zh": "需要咨询贝组替凡片药品渠道和价格信息？",
        "pinyin": "belzutifan",
    },
    {
        "num": 111,
        "name": "比克恩丙诺片",
        "generic_en": "Bictegravir/Emtricitabine/Tenofovir Alafenamide (Biktarvy/必妥维)",
        "brand": "LUCIBET",
        "category": "抗病毒",
        "indication": "作为完整方案治疗人类免疫缺陷病毒1型(HIV-1)感染的成人和体重≥25kg的儿童患者；适用于初治患者和病毒学抑制(接受稳定抗逆转录病毒方案HIV-1 RNA<50拷贝/mL)的患者",
        "spec": "每片含Bictegravir 50mg + 恩曲他滨(Emtricitabine)200mg + 丙酚替诺福韦(TAF)25mg",
        "category_label": "HIV-1三联复方抗病毒药",
        "drug_class": "HIV整合酶链转移抑制剂(INSTI)+ NRTI(核苷类逆转录酶抑制剂)双骨架三联复方",
        "moa": "Bictegravir是HIV整合酶链转移抑制剂,通过与HIV整合酶活性位点结合,阻断病毒DNA整合入宿主细胞基因组的链转移步骤;恩曲他滨和丙酚替诺福韦是核苷(酸)类似物,通过竞争性抑制HIV逆转录酶及掺入病毒DNA导致链终止,实现多靶点协同抗病毒",
        "dosage": "推荐剂量1片(50mg/200mg/25mg)，口服每日1次，可与食物同服或空腹；整片吞服，不可掰开、压碎或咀嚼；持续治疗直至病毒学失败或不可耐受",
        "monitor": "用药前必须确认HIV-1感染(HIV抗体+病毒载量)并筛查乙肝表面抗原(HBsAg,HBV合并感染患者停药可致HBV急性严重加重);治疗前及期间监测HIV-1 RNA病毒载量、CD4+T淋巴细胞计数、肾功能(估算肾小球滤过率eGFR,TAF有肾毒性)、肝功能;不可与利福平、圣约翰草、卡马西平等强CYP3A/UGT1A1诱导剂合用(显著降低比克恩丙诺血药浓度)",
        "adverse": "常见：头痛(≥5%)、腹泻、恶心、疲劳；不常见：梦境异常、眩晕、皮疹、腹痛、消化不良、肠胃气胀；严重：乳酸酸中毒伴脂肪变性(罕见但可致死)、乙肝合并感染急性加重(停药时)、免疫重建综合征(IRIS,治疗初期)、肾功能损害、近端肾小管病变、骨密度下降",
        "missed": "若漏服一剂，应在记起时尽快补服并恢复常规每日1次方案；若距下次服药不足18小时，跳过漏服剂量，下次按原计划服用；不可同时服用2倍剂量",
        "title_seo": "比克恩丙诺片用法用量详解｜Biktarvy必妥维 HIV-1三联复方长效抗病毒用药指南",
        "description_seo": "比克恩丙诺片(Bictegravir/FTC/TAF)用法用量详解，原研药Biktarvy必妥维治疗HIV-1感染，老挝LUCIBET版本咨询，全球优质医疗资源",
        "keywords_seo": "比克恩丙诺片,bictegravir用法,Biktarvy,必妥维,HIV-1抗病毒,三联复方,整合酶抑制剂,LUCIBET,艾滋病",
        "price_original": "Biktarvy 50mg/200mg/25mg×30片/盒 约3000-4500元(原研进口,部分国家医保覆盖)",
        "price_generic": "老挝LUCIBET 50mg/200mg/25mg×30片/盒 约1000-2000元(海外经济版)",
        "cta_title_zh": "需要咨询比克恩丙诺片药品渠道和价格信息？",
        "pinyin": "bictegravir",
    },
    {
        "num": 112,
        "name": "安立生坦片",
        "generic_en": "Ambrisentan Tablets (Letairis/凡瑞克)",
        "brand": "LuciAmb",
        "category": "肺动脉高压",
        "indication": "治疗有WHO功能分级II级或III级症状的肺动脉高压(PAH,WHO组1)成人患者,以改善运动能力和延缓临床恶化;支持有效性的研究主要包括特发性或遗传性PAH(64%)或结缔组织病相关性PAH(32%)病因学特征的患者",
        "spec": "5mg/片、10mg/片",
        "category_label": "选择性内皮素受体A(ETA)拮抗剂",
        "drug_class": "高选择性内皮素受体A(ETA)拮抗剂(ERA),选择性高于波生坦/马昔腾坦",
        "moa": "通过选择性阻断内皮素-1(ET-1)与ETA受体的结合,抑制ETA介导的肺血管平滑肌收缩和细胞增殖;PAH患者血浆ET-1浓度可升高10倍,ET-1与其受体结合后引起肺血管强烈收缩和重构;选择性ETA阻断可舒张肺血管、降低肺动脉压、延缓疾病进展",
        "dosage": "成人起始剂量5mg,口服每日1次,可空腹或随餐服用;若耐受,可在4周间隔后调整为10mg每日1次;不可掰开、压碎或咀嚼药片;持续治疗直至疾病进展或不可接受的不良反应",
        "monitor": "治疗前需有PAH确诊证据(右心导管测量平均肺动脉压mPAP≥20mmHg);用药前及治疗期间定期监测肝功能(AST/ALT,转氨酶升高>5xULN须停药)、血红蛋白(贫血,常见不良反应)、液体潴留/外周水肿(可能需利尿或干预);育龄期女性用药前须妊娠测试阴性,治疗期间每月妊娠测试,并使用2种合适避孕方法;不可与环孢素A合用超过5mg/日(显著增加安立生坦暴露)",
        "adverse": "常见：外周水肿/液体潴留(38%+,可能需干预)、贫血(血红蛋白下降,7-15%)、鼻充血(10%,剂量相关)、头痛(15%)、潮红、眩晕、心悸、腹痛、便秘、疲劳、呼吸困难、皮疹;严重：肝毒性(转氨酶升高、罕见肝衰竭报告)、重度贫血、致畸性(动物实验显示下颌/硬腭/心脏畸形,妊娠绝对禁忌)、心力衰竭(与液体潴留相关)、低血压",
        "missed": "若漏服一剂,应在当天记起时尽快补服;次日按常规时间服用下一剂;不可服用双倍剂量以弥补漏服",
        "title_seo": "安立生坦片用法用量详解｜凡瑞克Volibris选择性ETA拮抗剂肺动脉高压用药指南",
        "description_seo": "安立生坦片(Ambrisentan)用法用量详解，原研药凡瑞克/Volibris治疗WHO II-III级肺动脉高压(PAH),老挝LuciAmb版本咨询，全球优质医疗资源",
        "keywords_seo": "安立生坦片,ambrisentan用法,凡瑞克,Volibris,LuciAmb,肺动脉高压,PAH,ETA拮抗剂,内皮素受体拮抗剂",
        "price_original": "凡瑞克/Volibris 5mg×30片/盒 约3000-4500元(原研进口,已纳入部分国家医保)",
        "price_generic": "老挝LuciAmb 5mg×30片/盒 约500-800元(海外经济版)",
        "cta_title_zh": "需要咨询安立生坦片药品渠道和价格信息？",
        "pinyin": "ambrisentan",
    },
    {
        "num": 113,
        "name": "兰泽替尼片",
        "generic_en": "Lazertinib Tablets (LAZCLUZE/Leclaza)",
        "brand": "LuciLazer",
        "category": "肺癌",
        "indication": "联合amivantamab(埃万妥单抗)用于一线治疗局部晚期或转移性非小细胞肺癌(NSCLC)成人患者,其肿瘤经FDA批准的检测方法确认为表皮生长因子受体(EGFR)第19号外显子缺失(19del)或第21号外显子L858R替代突变;韩国MFDS还批准其用于既往EGFR-TKI治疗后出现T790M突变阳性的NSCLC",
        "spec": "80mg/片、240mg/片",
        "category_label": "第三代EGFR突变NSCLC靶向药",
        "drug_class": "第三代不可逆EGFR酪氨酸激酶抑制剂(TKI),对T790M耐药突变和敏感突变均有活性,选择性优于野生型EGFR",
        "moa": "通过共价结合EGFR激酶区的ATP结合位点,不可逆地抑制EGFR活性;对EGFR 19del、L858R等敏感突变和T790M耐药突变均有效,同时显著降低对野生型EGFR的抑制(减少皮疹/腹泻等脱靶毒性);血脑屏障穿透性良好(LASER301研究中颅内PFS数据优异),可有效控制脑转移",
        "dosage": "推荐剂量240mg(3片80mg或1片240mg),口服每日1次,可与食物同服或空腹;每天大致相同时间服用;整片吞服,不可咀嚼、压碎或溶解;当与amivantamab同日给药时,兰泽替尼可在amivantamab给药前任意时间口服;持续治疗直至疾病进展或不可接受的毒性",
        "monitor": "用药前必须经FDA/MFDS批准的检测方法确认为EGFR 19del或L858R突变;治疗前4个月建议常规预防性抗凝(直接口服抗凝药DOAC或低分子肝素)以预防静脉血栓栓塞(VTE,联合治疗VTE发生率36%);定期监测静脉血栓栓塞症状(下肢肿胀/疼痛/呼吸困难)、间质性肺病(ILD,3.1%发生率,确诊需永久停药)、皮疹(86%发生率,3级26%)、肝功能(ALT/AST)、心电图(QTc);联合amivantamab时同步监测输液反应、皮肤毒性",
        "adverse": "常见：皮疹(86%,3级26%)、指甲毒性(32%)、肌肉骨骼疼痛(24%)、口腔炎(19%)、静脉血栓栓塞(联合36%)、水肿(19%)、感觉异常(17%)、疲劳(13%)、腹泻(13%)、眼部毒性(16%如角膜炎)、瘙痒、恶心、COVID-19感染(联合方案中);严重：间质性肺病ILD(3.1%发生率,确诊永久停药)、3-4级VTE(尤其联合治疗,需预防性抗凝)、3级皮疹、重度肝毒性、心脏毒性(联合)、胚胎-胎儿毒性",
        "missed": "若漏服一剂且距下次服药时间超过12小时,可立即补服漏服剂量;若距下次服药不足12小时,则跳过本次剂量,次日按原计划继续用药;不可同时服用双倍剂量;若服药后发生呕吐,按漏服处理",
        "title_seo": "兰泽替尼片用法用量详解｜LAZCLUZE联合amivantamab EGFR突变NSCLC一线靶向用药指南",
        "description_seo": "兰泽替尼片(Lazertinib)用法用量详解，原研药LAZCLUZE/Leclaza联合amivantamab一线治疗EGFR 19del/L858R突变NSCLC,老挝LuciLazer版本咨询，全球优质医疗资源",
        "keywords_seo": "兰泽替尼片,lazertinib用法,LAZCLUZE,Leclaza,LuciLazer,EGFR突变NSCLC,amivantamab联合,三代EGFR-TKI,19del,L858R",
        "price_original": "LAZCLUZE 240mg×30片/盒 约25000-35000元(美国原研,2024年8月FDA批准)",
        "price_generic": "老挝LuciLazer 80mg×30片/盒 约5000-8000元(海外经济版)",
        "cta_title_zh": "需要咨询兰泽替尼片药品渠道和价格信息？",
        "pinyin": "lazertinib",
    },
]
...
def get_gzh_article(drug):
    title_emojis = {
        "阿法替尼片": ("🎯", "EGFR突变非小细胞肺癌第二代不可逆TKI靶向药"),
        "贝组替凡片": ("🧬", "全球首创HIF-2α抑制剂,VHL病与晚期肾癌精准靶向"),
        "比克恩丙诺片": ("🛡️", "HIV-1三联复方长效抗病毒,每日1片1片搞定"),
        "安立生坦片": ("🫁", "选择性ETA拮抗剂,WHO II-III级肺动脉高压靶向治疗"),
        "兰泽替尼片": ("🚀", "第三代EGFR-TKI联合amivantamab一线治疗EGFR突变NSCLC"),
    }
...
def main():
    ...
    output_dir = os.path.join(work_root, "蓝培医疗文章/2026-06-16")
