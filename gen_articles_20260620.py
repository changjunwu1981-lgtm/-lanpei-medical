...
# ============ 5个药品数据 ============
drugs = [
    # 129. 奥贝胆酸片 Obetohep (Alkem/Cadila)
    {
        'num': '129',
        'slug': 'obeticholic-obetohep',
        'drug_name': '奥贝胆酸片 Obetohep',
        'drug_subtitle': 'Obeticholic Acid Tablets 5mg/10mg (Obetohep, Alkem) - 原发性胆汁性胆管炎PBC二线靶向治疗 | 品牌:Ocaliva',
        'title': '奥贝胆酸片Obetohep用法用量详解｜Alkem 5mg FXR激动剂印度版PBC二线治疗',
        'description': '奥贝胆酸片Obetohep(Obeticholic Acid)用法用量详解,Alkem印度仿制版治疗对UDCA应答不足或不耐受的原发性胆汁性胆管炎PBC成人患者,FXR激动剂,海外用药咨询,全球优质医疗资源',
        'keywords': '奥贝胆酸,Obeticholic Acid,Ocaliva,Obetohep,Alkem,PBC,原发性胆汁性胆管炎,FXR激动剂,法尼醇X受体,印度仿制',
        'generic_name': '奥贝胆酸 (Obeticholic Acid)',
        'english_name': 'Obeticholic Acid Tablets 5mg/10mg (Obetohep, Alkem) - PBC',
        'brand_name': '原研药Ocaliva(Intercept Pharmaceuticals)、海外经济版Obetohep(Alkem)、Eticholic(Lupin)、OCANAT(Glenmark)、Ocabile(Sun Pharma)',
        'spec': '5mg/片、10mg/片,薄膜衣片',
        'drug_type': '法尼醇X受体(FXR)激动剂;Alkem Laboratories(印度五大制药企业之一)印度仿制版Obetohep,成分与原研Ocaliva基本一致;经印度药品监管机构批准上市,作为印度市场获批的PBC二线治疗选择之一;通过激活FXR抑制胆汁酸合成、改善胆汁排泄;在FDA对失代偿期肝硬化患者有黑框警告,需严格评估用药条件',
        ...
        'mechanism': 'Obetohep与原研Ocaliva同为奥贝胆酸(Obeticholic Acid),是鹅去氧胆酸(CDCA)的6α-乙基衍生物,为强效选择性法尼醇X受体(FXR)激动剂;FXR激活后通过负反馈抑制胆固醇7α-羟化酶(CYP7A1)表达,减少肝细胞内胆汁酸合成;同时上调胆汁酸输出泵(BSEP)和多药耐药相关蛋白(MRP2、MRP3、MRP4)表达,促进胆汁酸向胆管和血液排泄;还能抑制肠道FXR信号,促进FGF19分泌,进一步抑制肝脏胆汁酸合成;综合作用下可显著降低血清碱性磷酸酶(ALP)和总胆红素,改善PBC生化应答;Alkem版本作为仿制药与原研药在活性成分、剂型、规格、给药途径上一致,已通过印度药品监管机构的生物等效性评估',
        'standard_dose': '''                <li>无肝硬化或代偿期肝硬化无门静脉高压者:起始剂量5mg,每日一次,口服;治疗3个月后评估ALP和总胆红素:若应答不佳且耐受良好,可增至10mg,每日一次(最大剂量);可与食物同服或空腹服用;与胆汁酸结合树脂(考来烯胺)合用需间隔至少4小时</li>''',
        ...
        'precautions': '''                <li><strong>常见不良反应:</strong>常见(发生率较高):瘙痒(高达68%,剂量依赖性);肝功能异常(ALT/AST/胆红素升高约15%);其他:关节痛(14%)、头晕(10%)、便秘(8%)、皮疹(11%)、甲状腺功能异常(7%)、疲劳、腹痛、恶心、HDL-C下降;严重(罕见但需警惕):失代偿期肝硬化患者严重肝损伤(可能需肝移植或导致死亡,FDA黑框警告)</li>
        ...
        'price_rows': '''                    <tr>
                    ...
                    <tr>
                        <td>海外经济版</td>
                        <td>Obetohep (Alkem) / Eticholic (Lupin) / OCANAT (Glenmark) / Ocabile (Sun Pharma)</td>
                        <td>印度/孟加拉</td>
                        <td><span class="price-tag">Alkem Obetohep 10mg×10片印度市场零售价约396印度卢比/盒(约合人民币30多元);Eticholic(Lupin)、OCANAT(Glenmark)、Ocabile(Sun Pharma)、Obetohep(Alkem)等多家印度仿制版,经济性显著优于原研药,需经合规医疗资源咨询渠道获得</span><br><span class="text-xs text-gray-500">经正规海外医疗资源咨询渠道</span></td>
                    </tr>'''
    },
    # 130. 缬更昔洛韦片 VIROFIL (Glenmark) - 实际生产为Cadila Health Care
    {
        'num': '130',
        'slug': 'valganciclovir-virofil',
        'drug_name': '缬更昔洛韦片 VIROFIL',
        'drug_subtitle': 'Valganciclovir Hydrochloride Tablets 450mg (VIROFIL) - 抗巨细胞病毒CMV感染治疗 | 品牌:Valcyte(万赛维)',
        'title': '缬更昔洛韦片VIROFIL用法用量详解｜450mg片剂CMV巨细胞病毒感染治疗方案',
        'description': '缬更昔洛韦片VIROFIL(Valganciclovir Hydrochloride)用法用量详解,治疗AIDS患者CMV视网膜炎和高危器官移植后CMV疾病预防,更昔洛韦前体药物,海外抗病毒用药咨询,全球优质医疗资源',
        'keywords': '缬更昔洛韦,Valganciclovir,万赛维,Valcyte,VIROFIL,Cadila,CMV,巨细胞病毒,更昔洛韦前体,器官移植',
        'generic_name': '缬更昔洛韦盐酸盐 (Valganciclovir Hydrochloride)',
        'english_name': 'Valganciclovir Hydrochloride Tablets 450mg (VIROFIL) - Anti-CMV',
        'brand_name': '原研药Valcyte万赛维(Roche罗氏),海外经济版VIROFIL(Cadila/Zydus相关制造商)、VAGACYTE(Panacea Biotec)、Valgan(Cipla)、VALGACEL(Sun Pharma)、VALCHEK(La Renon)、Valstead(Steadfast)等',
        'spec': '450mg/片,薄膜衣片',
        'drug_type': '抗病毒药,更昔洛韦(Ganciclovir)的L-缬氨酰酯前体药物;口服后经肝/肠酯酶迅速水解为活性成分更昔洛韦,生物利用度约60%(远高于更昔洛韦胶囊的6%-9%);通过竞争性抑制CMV DNA聚合酶并整合入病毒DNA链,导致链终止,发挥抗CMV作用;原研药Roche Valcyte万赛维已在100多个国家获批;具有潜在致畸性、致癌性和生殖毒性,使用需严格遵循医嘱',
        'indications': '''                <li><strong>主要适应症(成人):</strong>①治疗获得性免疫缺陷综合征(AIDS)患者巨细胞病毒(CMV)视网膜炎(诱导治疗+维持治疗);②预防高危实体器官移植(肾移植、心脏移植、肾-胰腺联合移植)患者CMV疾病;肾移植患者预防用药从移植后10天内开始至移植后200天;心脏/肾-胰腺移植患者预防用药从移植后10天内开始至移植后100天</li>
                <li><strong>儿童适应症:</strong>用于从出生至18岁、接受CMV血清阳性供体实体器官移植后、CMV阴性的儿童患者预防CMV疾病;剂量按体表面积和Schwartz公式肌酐清除率计算(7×BSA×CrCl)</li>
                <li><strong>用药前提:</strong>必须由具有CMV感染/移植管理经验的专科医生启动;用药前需评估血常规(ANC、血小板)、肾功能(CrCl)、眼部状况(眼底检查);ANC<500/μL、血小板<25,000/μL或Hb<8g/dL者禁用;严重肾功能不全者需严格调整剂量;妊娠期绝对禁用(可能导致胎儿严重出生缺陷)</li>''',
        'mechanism': '缬更昔洛韦是更昔洛韦的L-缬氨酰酯前体药物,口服后经肝/肠壁酯酶迅速水解,释放活性成分更昔洛韦;更昔洛韦在CMV感染细胞内,先被病毒编码的UL97蛋白激酶磷酸化为单磷酸更昔洛韦,再经细胞激酶磷酸化为三磷酸更昔洛韦;三磷酸更昔洛韦竞争性抑制CMV DNA聚合酶,并通过整合入病毒DNA链导致链终止,选择性抑制CMV DNA合成;口服900mg缬更昔洛韦的更昔洛韦全身暴露量与静脉注射5mg/kg更昔洛韦相当;对CMV、HSV-1、HSV-2、EBV、VZV、HHV-6均有抑制作用,但对CMV活性最强',
        'standard_dose': '''                <li>成人CMV视网膜炎诱导治疗:900mg(2片),每日2次,口服,持续21天;维持治疗:900mg(2片),每日1次,口服;成人肾移植患者预防CMV:900mg,每日1次,口服,移植后10天内开始,持续至移植后200天;成人心脏/肾-胰腺移植患者预防:900mg,每日1次,口服,移植后10天内开始,持续至移植后100天;建议随餐服用以提高生物利用度</li>''',
        'administration': '''                <li>每日固定时间服用,整片吞服,不可掰开、压碎或咀嚼(避免潜在致畸性物质接触皮肤/黏膜)</li>
                <li>建议随餐服用(可显著提高生物利用度约30%)</li>
                <li>操作药片前后用肥皂水洗手;不慎接触破损皮肤或眼睛需立即用大量清水彻底冲洗</li>
                <li>漏服处理:尽快补服;若接近下一次服药时间则跳过本次,不可双倍补服</li>
                <li>不可突然停药;用药期间和停药后30天内需采取有效避孕措施(妊娠期绝对禁用)</li>''',
        'dose_adjust': '''                <li>肾功能不全成人剂量调整(基于CrCl):CrCl≥60mL/min——诱导期900mg bid,维持/预防900mg qd;CrCl 40-59mL/min——诱导期450mg bid,维持/预防450mg qd;CrCl 25-39mL/min——诱导期450mg qd,维持/预防450mg q48h;CrCl 10-24mL/min——诱导期450mg q48h,维持/预防450mg biw;CrCl<10mL/min(血液透析)——无法推荐剂量</li>
                <li>儿童剂量按7×BSA×CrCl公式计算(Schwartz公式);若计算剂量超过900mg,最大剂量900mg/天</li>
                <li>用药期间ANC<500/μL、血小板<25,000/μL或Hb<8g/dL:立即停药</li>
                <li>老年人(≥65岁):需根据肾功能调整剂量,加强血常规和肾功能监测</li>''',
        'monitoring': '用药前:全血细胞计数(ANC、血小板、Hb基线)、肾功能(Scr、CrCl)、肝功能、电解质、眼底检查(视网膜炎患者);用药期间:每2-4周监测全血细胞计数(因可能发生严重骨髓抑制)、每月监测肾功能;出现以下情况立即停药:ANC<500/μL、血小板<25,000/μL、Hb<8g/dL(严重骨髓抑制);治疗CMV视网膜炎时需定期(每4-6周)眼科检查评估视网膜病变;长期用药者定期监测肝功能、电解质',
        'precautions': '''                <li><strong>常见不良反应:</strong>常见(发生率较高):腹泻、恶心、呕吐、腹痛;中性粒细胞减少(发生率15-25%,严重骨髓抑制)、血小板减少、贫血;头痛、失眠、周围神经病变;视网膜脱离(视网膜炎患者发生率15-20%);发热、疲劳;皮疹、瘙痒;严重(罕见但需警惕):严重骨髓抑制(粒缺、贫血、血小板减少)、肾衰竭、癫痫、胰腺炎、严重过敏反应;基于动物数据可能致畸、致癌、影响生育</li>
                <li><strong>禁忌:</strong>对本品或更昔洛韦过敏者禁用;ANC<500/μL、血小板<25,000/μL或Hb<8g/dL者禁用;妊娠期绝对禁用(动物研究显示严重致畸性);哺乳期禁用</li>
                <li><strong>特殊人群:</strong>儿童:可用于移植后预防(需按公式计算剂量);老年人:需根据肾功能调整剂量;育龄期男女:用药期间及停药后至少90天需严格避孕(男性精子生成可能受抑);肾功能不全者:严格按CrCl调整剂量</li>
                <li><strong>驾驶操作:</strong>用药期间如出现头晕、嗜睡、癫痫等避免驾驶或操作机械</li>
                <li><strong>药物相互作用:</strong>与骨髓抑制药物(齐多夫定、化疗药)合用增加骨髓毒性;与肾毒性药物(氨基糖苷类、环孢素、两性霉素B)合用增加肾毒性;丙磺舒可能减少肾小管分泌;与亚胺培南-西司他丁合用可能增加癫痫风险;不可与更昔洛韦同时使用(过量风险)</li>''',
        'price_rows': '''                    <tr>
                        <td>原研药</td>
                        <td>Valcyte 万赛维 (Roche 罗氏)</td>
                        <td>瑞士/全球100+国家(2001年FDA)</td>
                        <td><span class="price-tag">Valcyte 450mg×60片美国上市价约5000-7000美元/盒(约合人民币3.6-5万元);欧盟价格近似;中国国内450mg×60片约1万多元人民币(自费,医保未纳入);原研药价格高昂,需经合规医疗资源咨询渠道获得</span><br><span class="text-xs text-gray-500">原研药参考价</span></td>
                    </tr>
                    <tr>
                        <td>海外经济版</td>
                        <td>VIROFIL (Cadila) / VAGACYTE (Panacea) / Valgan (Cipla) / VALGACEL (Sun) / Valstead (Steadfast)</td>
                        <td>印度</td>
                        <td><span class="price-tag">Valgan(Cipla)450mg×4片/盒印度市场零售价约1500印度卢比(约合人民币120-130元);VAGACYTE(Panacea)450mg×2片/盒MRP约682.50印度卢比(约合人民币60元);VIROFIL(Cadila)及多家印度仿制版,经济性显著优于原研药(约1/30至1/100),需经合规医疗资源咨询渠道获得</span><br><span class="text-xs text-gray-500">经正规海外医疗资源咨询渠道</span></td>
                    </tr>'''
    },
    # 131. 缬更昔洛韦片 VAGACYTE (ALEMBIC) - 实际为Panacea Biotec
    {
        'num': '131',
        'slug': 'valganciclovir-vagacyte',
        'drug_name': '缬更昔洛韦片 VAGACYTE',
        'drug_subtitle': 'Valganciclovir Hydrochloride Tablets 450mg (VAGACYTE, Panacea Biotec) - 抗巨细胞病毒CMV感染治疗 | 品牌:Valcyte(万赛维)',
        'title': '缬更昔洛韦片VAGACYTE用法用量详解｜Panacea Biotec 450mg移植后CMV预防治疗',
        'description': '缬更昔洛韦片VAGACYTE(Valganciclovir Hydrochloride)用法用量详解,Panacea Biotec印度仿制版,AIDS患者CMV视网膜炎治疗+器官移植后CMV疾病预防,更昔洛韦前体药物,海外抗病毒用药咨询,全球优质医疗资源',
        'keywords': '缬更昔洛韦,Valganciclovir,万赛维,Valcyte,VAGACYTE,Panacea Biotec,CMV,巨细胞病毒,更昔洛韦前体,移植后预防',
        'generic_name': '缬更昔洛韦盐酸盐 (Valganciclovir Hydrochloride)',
        'english_name': 'Valganciclovir Hydrochloride Tablets 450mg (VAGACYTE, Panacea Biotec) - Anti-CMV',
        'brand_name': '原研药Valcyte万赛维(Roche罗氏),海外经济版VAGACYTE(Panacea Biotec)、VIROFIL(Cadila)、Valgan(Cipla)、VALGACEL(Sun Pharma)、VALCHEK(La Renon)等',
        'spec': '450mg/片,薄膜衣片',
        'drug_type': '抗病毒药,更昔洛韦(Ganciclovir)的L-缬氨酰酯前体药物;Panacea Biotec(印度知名疫苗和生物制药公司,移植领域专业)仿制版VAGACYTE,成分与原研Valcyte一致;经印度药品监管机构(DCGI)批准上市,在印度移植科领域应用广泛;口服后经肝/肠酯酶水解为活性更昔洛韦,生物利用度约60%;具有潜在致畸性、致癌性和生殖毒性',
        'indications': '''                <li><strong>主要适应症(成人):</strong>①治疗AIDS患者CMV视网膜炎(诱导期900mg bid×21天,维持期900mg qd);②预防肾移植、心脏移植、肾-胰腺联合移植后CMV疾病(肾移植:移植后10天内开始至200天;心脏/肾-胰腺移植:移植后10天内开始至100天;均900mg qd)</li>
                <li><strong>儿童适应症:</strong>从出生至18岁、接受CMV血清阳性供体实体器官移植后、CMV阴性儿童预防CMV疾病;剂量按7×BSA×Schwartz CrCl计算(最大900mg/天)</li>
                <li><strong>用药前提:</strong>须由具有CMV感染/移植管理经验专科医生启动;用药前需评估血常规、肾功能、眼部;ANC<500/μL、血小板<25,000/μL或Hb<8g/dL者禁用;严重肾功能不全者需严格剂量调整;妊娠期绝对禁用</li>''',
        'mechanism': '缬更昔洛韦是更昔洛韦的L-缬氨酰酯前体,口服后经肝/肠壁酯酶迅速水解为活性更昔洛韦;更昔洛韦在CMV感染细胞内,先被病毒UL97蛋白激酶磷酸化为单磷酸更昔洛韦,再经细胞激酶转化为三磷酸更昔洛韦;三磷酸更昔洛韦竞争性抑制CMV DNA聚合酶,并通过整合入病毒DNA链导致链终止,选择性抑制CMV DNA复制;口服900mg缬更昔洛韦的更昔洛韦全身暴露量相当于静脉5mg/kg更昔洛韦;Panacea Biotec版本作为仿制药与原研药在活性成分、剂型、规格、给药途径上一致,经印度DCGI批准上市,在治疗等效性方面与原研药基本一致',
        'standard_dose': '''                <li>成人CMV视网膜炎诱导治疗:900mg(2片),每日2次,口服,持续21天;维持治疗:900mg,每日1次,口服;成人肾移植患者预防CMV:900mg,每日1次,移植后10天内开始,持续至移植后200天;成人心脏/肾-胰腺移植预防:900mg,每日1次,移植后10天内开始,持续至移植后100天;建议随餐服用</li>''',
        'administration': '''                <li>每日固定时间服用,整片吞服,不可掰开、压碎或咀嚼(避免潜在致畸性物质接触皮肤/黏膜)</li>
                <li>建议随餐服用(可显著提高生物利用度)</li>
                <li>操作药片前后用肥皂水洗手;不慎接触破损皮肤或眼睛立即用大量清水彻底冲洗</li>
                <li>漏服处理:尽快补服;若接近下一次服药时间则跳过,不可双倍补服</li>
                <li>不可突然停药;用药期间及停药后90天内严格避孕</li>''',
        'dose_adjust': '''                <li>肾功能不全成人剂量调整(CrCl为基准):≥60mL/min:诱导900mg bid/维持900mg qd;40-59:诱导450mg bid/维持450mg qd;25-39:诱导450mg qd/维持450mg q48h;10-24:诱导450mg q48h/维持450mg biw;<10(透析):无推荐剂量</li>
                <li>儿童按7×BSA×CrCl公式计算(最大900mg/天);若计算剂量>900mg,最大900mg/天</li>
                <li>ANC<500/μL、血小板<25,000/μL或Hb<8g/dL:立即停药</li>
                <li>老年人根据肾功能调整剂量,加强血常规和肾功能监测</li>''',
        'monitoring': '用药前:全血细胞计数(ANC、血小板、Hb基线)、肾功能(Scr、CrCl)、肝功能、电解质、眼底检查;用药期间:每2-4周监测全血细胞计数(骨髓抑制风险高);每月监测肾功能;出现ANC<500/μL、血小板<25,000/μL、Hb<8g/dL立即停药;CMV视网膜炎患者需每4-6周眼科评估;长期用药者监测肝功能、电解质',
        'precautions': '''                <li><strong>常见不良反应:</strong>常见:腹泻、恶心、呕吐、腹痛;中性粒细胞减少(15-25%)、血小板减少、贫血;头痛、失眠、周围神经病变;视网膜脱离(15-20%);发热、疲劳;皮疹、瘙痒;严重:严重骨髓抑制(粒缺、贫血、血小板减少)、肾衰竭、癫痫、胰腺炎、严重过敏;基于动物数据可能致畸、致癌、影响生育</li>
                <li><strong>禁忌:</strong>对本品或更昔洛韦过敏者禁用;ANC<500/μL、血小板<25,000/μL或Hb<8g/dL者禁用;妊娠期绝对禁用;哺乳期禁用</li>
                <li><strong>特殊人群:</strong>儿童:可用于移植后预防(按公式计算);老年人:根据肾功能调整剂量;育龄男女:用药期间及停药后至少90天严格避孕(男性精子生成可能受抑);肾功能不全:严格按CrCl调整</li>
                <li><strong>药物相互作用:</strong>与骨髓抑制药(齐多夫定、化疗药)合用增加骨髓毒性;与肾毒性药(氨基糖苷、环孢素、两性霉素B)合用增加肾毒性;丙磺舒可能减少肾小管分泌;与亚胺培南-西司他丁合用可能增加癫痫风险;不可与更昔洛韦同时使用</li>''',
        'price_rows': '''                    <tr>
                        <td>原研药</td>
                        <td>Valcyte 万赛维 (Roche 罗氏)</td>
                        <td>瑞士/全球100+国家(2001年FDA)</td>
                        <td><span class="price-tag">Valcyte 450mg×60片美国上市价约5000-7000美元/盒(约合人民币3.6-5万元);中国国内450mg×60片约1万多元人民币(自费,医保未纳入);原研药价格高昂,需经合规医疗资源咨询渠道获得</span><br><span class="text-xs text-gray-500">原研药参考价</span></td>
                    </tr>
                    <tr>
                        <td>海外经济版</td>
                        <td>VAGACYTE (Panacea Biotec) / VIROFIL (Cadila) / Valgan (Cipla) / VALGACEL (Sun) / VALCHEK (La Renon)</td>
                        <td>印度</td>
                        <td><span class="price-tag">VAGACYTE(Panacea Biotec)450mg×2片/盒印度市场MRP约682.50印度卢比(约合人民币60元);Valgan(Cipla)450mg×4片/盒约1500印度卢比(约合人民币120-130元);多家印度仿制版经济性显著(约原研药1/30至1/100),需经合规医疗资源咨询渠道获得</span><br><span class="text-xs text-gray-500">经正规海外医疗资源咨询渠道</span></td>
                    </tr>'''
    },
    # 132. 缬更昔洛韦片 VALGACEL (SUN)
    {
        'num': '132',
        'slug': 'valganciclovir-valgacel',
        'drug_name': '缬更昔洛韦片 VALGACEL',
        'drug_subtitle': 'Valganciclovir Hydrochloride Tablets 450mg (VALGACEL, Sun Pharma) - 抗巨细胞病毒CMV感染治疗 | 品牌:Valcyte(万赛维)',
        'title': '缬更昔洛韦片VALGACEL用法用量详解｜Sun Pharma 450mg印度版CMV治疗与移植后预防',
        'description': '缬更昔洛韦片VALGACEL(Valganciclovir Hydrochloride)用法用量详解,Sun Pharma印度仿制版,AIDS患者CMV视网膜炎治疗+器官移植后CMV疾病预防,更昔洛韦前体药物,海外抗病毒用药咨询,全球优质医疗资源',
        'keywords': '缬更昔洛韦,Valganciclovir,万赛维,Valcyte,VALGACEL,Sun Pharma,CMV,巨细胞病毒,更昔洛韦前体,移植后预防',
        'generic_name': '缬更昔洛韦盐酸盐 (Valganciclovir Hydrochloride)',
        'english_name': 'Valganciclovir Hydrochloride Tablets 450mg (VALGACEL, Sun Pharma) - Anti-CMV',
        'brand_name': '原研药Valcyte万赛维(Roche罗氏),海外经济版VALGACEL(Sun Pharma)、VIROFIL(Cadila)、VAGACYTE(Panacea)、Valgan(Cipla)、VALCHEK(La Renon)等',
        'spec': '450mg/片,薄膜衣片',
        'drug_type': '抗病毒药,更昔洛韦(Ganciclovir)的L-缬氨酰酯前体药物;Sun Pharma(全球第四大仿制药公司,印度最大制药企业)印度仿制版VALGACEL,成分与原研Valcyte基本一致;经印度药品监管机构批准上市,作为全球CMV治疗与移植预防的主流仿制选择;口服后经酯酶水解为更昔洛韦,生物利用度约60%;具有潜在致畸性、致癌性和生殖毒性',
        'indications': '''                <li><strong>主要适应症(成人):</strong>①治疗AIDS患者CMV视网膜炎(诱导期900mg bid×21天,维持期900mg qd);②预防肾移植、心脏移植、肾-胰腺联合移植后CMV疾病(肾移植:移植后10天内至200天,900mg qd;心脏/肾-胰腺:移植后10天内至100天,900mg qd)</li>
                <li><strong>儿童适应症:</strong>从出生至18岁、接受CMV血清阳性供体实体器官移植后、CMV阴性儿童预防CMV疾病;剂量按7×BSA×Schwartz CrCl计算(最大900mg/天)</li>
                <li><strong>用药前提:</strong>须由具有CMV感染/移植管理经验专科医生启动;用药前评估血常规、肾功能、眼部;ANC<500/μL、血小板<25,000/μL或Hb<8g/dL者禁用;严重肾功能不全需严格调整;妊娠期绝对禁用</li>''',
        'mechanism': '缬更昔洛韦是更昔洛韦的L-缬氨酰酯前体,口服后经肝/肠壁酯酶迅速水解为活性更昔洛韦;更昔洛韦在CMV感染细胞内,先被病毒UL97蛋白激酶磷酸化为单磷酸更昔洛韦,再经细胞激酶转化为三磷酸更昔洛韦;三磷酸更昔洛韦竞争性抑制CMV DNA聚合酶,并通过整合入病毒DNA链导致链终止,选择性抑制CMV DNA复制;口服900mg缬更昔洛韦的更昔洛韦全身暴露量相当于静脉5mg/kg更昔洛韦;Sun Pharma版本作为全球第四大仿制药公司的产品,通过印度DCGI的严格审查,在治疗等效性方面与原研药基本一致',
        'standard_dose': '''                <li>成人CMV视网膜炎诱导治疗:900mg(2片),每日2次,口服,持续21天;维持治疗:900mg,每日1次,口服;成人肾移植患者预防CMV:900mg,每日1次,移植后10天内开始,持续至移植后200天;成人心脏/肾-胰腺移植预防:900mg,每日1次,移植后10天内开始,持续至移植后100天;建议随餐服用</li>''',
        'administration': '''                <li>每日固定时间服用,整片吞服,不可掰开、压碎或咀嚼(避免潜在致畸性物质接触皮肤/黏膜)</li>
                <li>建议随餐服用(可显著提高生物利用度)</li>
                <li>操作药片前后用肥皂水洗手;不慎接触破损皮肤或眼睛立即用大量清水彻底冲洗</li>
        ...
        'price_rows': '''                    <tr>
                    ...
                    <tr>
                        <td>海外经济版</td>
                        <td>VALGACEL (Sun Pharma) / VIROFIL (Cadila) / VAGACYTE (Panacea) / Valgan (Cipla) / VALCHEK (La Renon)</td>
                        <td>印度</td>
                        <td><span class="price-tag">VALGACEL(Sun Pharma)及Valgan(Cipla)、VAGACYTE(Panacea)、VIROFIL(Cadila)、VALCHEK(La Renon)等多家印度仿制版,经济性显著优于原研药(约原研1/30至1/100),需经合规医疗资源咨询渠道获得</span><br><span class="text-xs text-gray-500">经正规海外医疗资源咨询渠道</span></td>
                    </tr>'''
    },
    # 133. 缬更昔洛韦片 Valgan (CIPLA)
    {
        'num': '133',
        'slug': 'valganciclovir-valgan',
        'drug_name': '缬更昔洛韦片 Valgan',
        'drug_subtitle': 'Valganciclovir Hydrochloride Tablets 450mg (Valgan, Cipla) - 抗巨细胞病毒CMV感染治疗 | 品牌:Valcyte(万赛维)',
        'title': '缬更昔洛韦片Valgan用法用量详解｜Cipla 450mg印度版CMV治疗与移植后预防',
        'description': '缬更昔洛韦片Valgan(Valganciclovir Hydrochloride)用法用量详解,Cipla印度仿制版,AIDS患者CMV视网膜炎治疗+器官移植后CMV疾病预防,更昔洛韦前体药物,海外抗病毒用药咨询,全球优质医疗资源',
        'keywords': '缬更昔洛韦,Valganciclovir,万赛维,Valcyte,Valgan,Cipla,CMV,巨细胞病毒,更昔洛韦前体,移植后预防,印度仿制',
        'generic_name': '缬更昔洛韦盐酸盐 (Valganciclovir Hydrochloride)',
        'english_name': 'Valganciclovir Hydrochloride Tablets 450mg (Valgan, Cipla) - Anti-CMV',
        'brand_name': '原研药Valcyte万赛维(Roche罗氏),海外经济版Valgan(Cipla)、VIROFIL(Cadila)、VAGACYTE(Panacea)、VALGACEL(Sun Pharma)、VALCHEK(La Renon)等',
        'spec': '450mg/片,薄膜衣片',
        'drug_type': '抗病毒药,更昔洛韦(Ganciclovir)的L-缬氨酰酯前体药物;Cipla(印度第二大制药企业,全球抗病毒仿制药主要供应商之一)印度仿制版Valgan,成分与原研Valcyte基本一致;经印度药品监管机构批准上市,在全球抗HIV/抗病毒仿制市场占据重要地位;口服后经酯酶水解为更昔洛韦,生物利用度约60%;具有潜在致畸性、致癌性和生殖毒性',
        'indications': '''                <li><strong>主要适应症(成人):</strong>①治疗AIDS患者CMV视网膜炎(诱导期900mg bid×21天,维持期900mg qd);②预防肾移植、心脏移植、肾-胰腺联合移植后CMV疾病(肾移植:移植后10天内至200天,900mg qd;心脏/肾-胰腺:移植后10天内至100天,900mg qd)</li>
                <li><strong>儿童适应症:</strong>从出生至18岁、接受CMV血清阳性供体实体器官移植后、CMV阴性儿童预防CMV疾病;剂量按7×BSA×Schwartz CrCl计算(最大900mg/天)</li>
                <li><strong>用药前提:</strong>须由具有CMV感染/移植管理经验专科医生启动;用药前评估血常规、肾功能、眼部;ANC<500/μL、血小板<25,000/μL或Hb<8g/dL者禁用;严重肾功能不全需严格调整;妊娠期绝对禁用</li>''',
        'mechanism': '缬更昔洛韦是更昔洛韦的L-缬氨酰酯前体,口服后经肝/肠壁酯酶迅速水解为活性更昔洛韦;更昔洛韦在CMV感染细胞内,先被病毒UL97蛋白激酶磷酸化为单磷酸更昔洛韦,再经细胞激酶转化为三磷酸更昔洛韦;三磷酸更昔洛韦竞争性抑制CMV DNA聚合酶,并通过整合入病毒DNA链导致链终止,选择性抑制CMV DNA复制;口服900mg缬更昔洛韦的更昔洛韦全身暴露量相当于静脉5mg/kg更昔洛韦;Cipla作为全球抗病毒仿制专家,Valgan版本与原研药在活性成分、剂型、规格、给药途径上一致,经印度DCGI的严格审查批准上市',
        'standard_dose': '''                <li>成人CMV视网膜炎诱导治疗:900mg(2片),每日2次,口服,持续21天;维持治疗:900mg,每日1次,口服;成人肾移植患者预防CMV:900mg,每日1次,移植后10天内开始,持续至移植后200天;成人心脏/肾-胰腺移植预防:900mg,每日1次,移植后10天内开始,持续至移植后100天;建议随餐服用</li>''',
        'administration': '''                <li>每日固定时间服用,整片吞服,不可掰开、压碎或咀嚼(避免潜在致畸性物质接触皮肤/黏膜)</li>
                <li>建议随餐服用(可显著提高生物利用度)</li>
                <li>操作药片前后用肥皂水洗手;不慎接触破损皮肤或眼睛立即用大量清水彻底冲洗</li>
        ...
        'price_rows': '''                    <tr>
                    ...
                    <tr>
                        <td>海外经济版</td>
                        <td>Valgan (Cipla) / VIROFIL (Cadila) / VAGACYTE (Panacea) / VALGACEL (Sun) / VALCHEK (La Renon)</td>
                        <td>印度</td>
                        <td><span class="price-tag">Valgan(Cipla)450mg×4片/盒印度市场零售价约1500印度卢比(约合人民币120-130元);VAGACYTE(Panacea)450mg×2片/盒约682.50印度卢比(约合人民币60元);多家印度仿制版经济性显著优于原研药(约原研1/30至1/100),需经合规医疗资源咨询渠道获得</span><br><span class="text-xs text-gray-500">经正规海外医疗资源咨询渠道</span></td>
                    </tr>'''
    },
]
...
# ============ 生成文件 ============
def render(d):
    html = HEAD_TPL + BODY_HEADER + CHAT_WIDGET
    # 替换占位符
...
# 生成网站版HTML
output_dir = "/app/data/所有对话/主对话/蓝培医疗文章/2026-06-20"
